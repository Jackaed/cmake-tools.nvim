...
SET(Kokkos_OPTIONS IMPL_CUDA_MALLOC_ASYNC;DEPRECATED_CODE_4;DEPRECATION_WARNINGS;DEBUG;DEBUG_DUALVIEW_MODIFY_CHECK;AGGRESSIVE_VECTORIZATION;IMPL_REF_COUNT_BRANCH_UNLIKELY;IMPL_MDSPAN;IMPL_SKIP_COMPILER_MDSPAN;COMPLEX_ALIGN)
SET(Kokkos_TPLS LIBDL)
SET(Kokkos_ARCH )
SET(Kokkos_CXX_COMPILER "/nix/store/rjsfx6sxjpkgd4f9hl9apm0n8dk7jd9w-clang-wrapper-19.1.0-rc2/bin/clang++")
SET(Kokkos_CXX_COMPILER_ID "Clang")
SET(Kokkos_CXX_COMPILER_VERSION "19.1.0")
...
FUNCTION(kokkos_compilation)
    ...
    SET(_HINTS "${MAYBE_CURRENT_INSTALLATION_ROOT}" "/var/empty/local")
